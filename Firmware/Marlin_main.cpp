...
static int pause_switch_e0 = 0; //Initialialising syringe extruder endstop placeholder values - MM2SE
static int pause_switch_e1 = 0;
...
#if defined(PAUSE_PIN_E1) && PAUSE_PIN_E1 > -1  //Secondary Extruder Endstop
pinMode(PAUSE_PIN_E1,INPUT);
WRITE(PAUSE_PIN_E1,HIGH);
pause_switch_e1 = 0;
#endif
}
...
void manage_inactivity()
{
  ...
  if(stepper_inactive_time)  {
    ...
    if( 0 == READ(KILL_PIN) )
      kill();
  #endif
  #if defined (PAUSE_PIN_E0) && PAUSE_PIN_E0 > -1 //Pause function for syringe extruder endstops - MM2SE
  if( 0 == READ(PAUSE_PIN_E0) )  //Main Exstruder Endstop
  pause();
  else 
  pause_switch_e0 = 0;
  #endif
  #if defined (PAUSE_PIN_E1) && PAUSE_PIN_E1 > -1
  if( 0 == READ(PAUSE_PIN_E1) )  //Secondary Extruder Endstop
  pause();
  else 
  pause_switch_e1 = 0;
  #endif
